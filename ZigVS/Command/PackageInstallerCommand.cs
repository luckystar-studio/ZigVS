...
#nullable enable
    internal sealed class PackageInstallerCommand
    {
        static PackageInstallerCommand? s_Instance = null;
        ...
        public static async System.Threading.Tasks.Task InitializeAsync()
        {
            await System.Threading.Tasks.Task.Run(() =>
            {
                ...
                s_Instance = new PackageInstallerCommand(l_OleMenuCommandService);
            });
        }

        private PackageInstallerCommand(OleMenuCommandService i_OleMenuCommandService)
        {
            if (i_OleMenuCommandService != null)
            {
                var menuCommandID = new CommandID(CommandDefinition.s_CommandSetGuid, (int)CommandDefinition.CommandId.PackageInstaller);

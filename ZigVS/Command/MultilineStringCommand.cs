...
#nullable enable
    ...
    public class MultilineStringCommand : AddRemoveSeparatorCommandBase
    {
        public MultilineStringCommand(
        ...
        public new static Task InitializeAsync()
        {
            s_Instance = new MultilineStringCommand(
                ...
                Type.Add,
                @"\\",
                (int)CommandDefinition.CommandId.AddMultiLineStringCommentId);
            return Task.CompletedTask;
        }
    }

    public class RemoveMultilineStringCommand : AddRemoveSeparatorCommandBase
    {
        public RemoveMultilineStringCommand(
            string i_typeNameString,
            Type i_Type,
            string i_separatorString,
            int i_commandIDInt) :
        ...
        public new static Task InitializeAsync()
        {
            s_Instance = new RemoveMultilineStringCommand(
                ...
                Type.Remove,
                @"\\",
                (int)CommandDefinition.CommandId.RemoveMultiLineStringCommentId);
            return Task.CompletedTask;
        }
    }
}

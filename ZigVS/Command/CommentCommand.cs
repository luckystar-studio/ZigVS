...
#nullable enable
    ...
    public class AddCommentCommand : AddRemoveSeparatorCommandBase
    {
        ...
        public new static Task InitializeAsync()
        {
            s_Instance = new AddCommentCommand(
                ...
                Type.Add,
                "//",
                (int)CommandDefinition.CommandId.AddComment);
            return Task.CompletedTask;
        }
    }

    public class RemoveCommentCommand : AddRemoveSeparatorCommandBase
    {
        ...
        public new static Task InitializeAsync()
        {
            s_Instance = new RemoveCommentCommand(
                ...
                Type.Remove,
                "//",
                (int)CommandDefinition.CommandId.RemoveComment);
            return Task.CompletedTask;
        }
    }
}

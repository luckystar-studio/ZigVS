...
namespace ZigVS
{
    ...
    [ExportFileContextProvider(
        ...
        supportedContextTypeGuids: new[] { /* BuildContextTypes.RebuildContextType,*/
    ...
    {
        private const string c_GuidString = "{DC8C00ED-A325-4C7A-BD7A-3F77E4B4131A}";
        public static readonly Guid s_ProviderTypeGuid = new Guid(c_GuidString);

        public IFileContextProvider CreateProvider(IWorkspace i_IWorkspace)
        {
